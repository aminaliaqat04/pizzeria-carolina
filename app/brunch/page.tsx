...
import BannerBg from "../../public/brunch-img-2.png"
import { brunchMenu, pizzeBiancheMenu, pizzeRosseMenu } from "@/data/menu";
  ...
  return (
    <>
      <div className="min-h-screen overflow-hidden relative flex justify-center items-center">
        ...
        <h1 className="uppercase max-lg:text-4xl lg:text-6xl text-[--light-color] font-bold tracking-widest text-center">Brunch Menu</h1>
        <div className="h-48 bg-gradient-to-t from-[--dark-color] to-transparent absolute bottom-0 w-full -z-10"></div>
      </div>
      <div className="bg-[--dark-color] text-[--light-color] flex flex-col items-center gap-5 py-20 pt-32 lg:px-10 max-lg:px-5 z-10">
        <div className="border-4 border-[--light-color] outline-1 outline-offset-4 outline-[--light-color] outline px-10 py-20 w-full lg:w-2/3 mx-auto">
          <h2 className="uppercase text-3xl text-center font-bold">Brunch</h2>
          <hr className="w-6 h-[0.03rem] bg-[--light-color] mt-2 mb-8 mx-auto" />
          <Menu menuArray={brunchMenu} />
        </div>
      </div>
    </>
  )
