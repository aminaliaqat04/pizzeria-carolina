...
export default function page() {
  return (
    <>
      ...
      {/* Chef Graz */}
      <div className="bg-[--dark-color] flex max-lg:flex-col max-lg:gap-5 justify-between items-center p-5 text-[--light-color] overflow-hidden">
        ...
        <div className="lg:w-[35rem] max-lg:w-full border-4 border-[--light-color] outline-1 outline-offset-4 outline-[--light-color] outline flex flex-col justify-center items-center gap-5 max-xl:px-10 xl:px-20 lg:py-20 max-lg:py-10 text-center z-10 card-wrapper">
      ...
      <div className="bg-[--dark-color] text-[--light-color] flex max-lg:flex-col gap-5 justify-around items-center w-full max-lg:py-10">
        <p className="font-montserrat text-center lg:w-2/5 px-10 max-lg:order-1">Now he is realizing his dream of opening his own restaurant where he can further showcase the flavours and traditions of Neapolitan cooking!</p>
        <div className="flex justify-center w-1/2"><Image src={NaplesImg} alt="" className="brightness-75" /></div>
      </div>

      <div className="bg-[--dark-color] text-[--light-color] px-5 lg:py-20 max-lg:pb-20 text-center space-y-10 flex flex-col gap-10">
        <p className="lg:text-lg lg:w-1/2 mx-auto !leading-loose font-montserrat max-lg:order-1"><span className="lg:text-3xl font-economica">Chef Graz</span> teaching <span className="lg:text-3xl font-economica">Fred Vanvleet</span>, point guard from the Toronto Raptors, how to handle a layup Neapolitan style!</p>
        <div className="grid lg:grid-cols-2 lg:gap-20 max-lg:gap-5">
